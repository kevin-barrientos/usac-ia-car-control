...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private boolean mMultiPaneSuportDevice;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setupActionBar();
        if(!mMultiPaneSuportDevice){
    ...
    public boolean onIsMultiPane() {
        mMultiPaneSuportDevice =  isLargeTablet(this);
        return mMultiPaneSuportDevice;
    }

    /**
     * Helper method to determine if the device has an large screen
     * with at least approximately 480x640 dp units.
     */
